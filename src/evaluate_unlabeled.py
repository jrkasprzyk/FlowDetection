...
def main():
    ...
    image_path = set_custom_path("/Users/malo1039/Library/CloudStorage/OneDrive-UCB-O365/Datasets/flow_detection_unlabeled_camera_b")
    # add my image path here and comment out the line above to replace it.
